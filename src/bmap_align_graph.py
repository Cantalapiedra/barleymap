...
# bmap_align_graph.py is part of Barleymap.
...
# positions from fasta protein seqs.
############################################
...
DEFAULT_ALIGNER_LIST = ["align2graph"]
...
try:
    ...
    if totalprot > 0:
        optParser.exit(0, "Bad sequence: please make sure input file contains nucleotide sequences\n")
