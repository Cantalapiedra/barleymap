...
def __filter_miniprot_results(results, threshold_id, threshold_cov, db_name, verbose = False):
    ...
    for line in results:
        ...
        #sys.stderr.write("m2p_miniprot Result "+str(line)+"\n")
        ...
        if strand == "+":
            ...
            raise Exception("m2p_miniprot: wrong strand "+str(strand)+".")
        ...
        if query_id in filter_dict:
            ...
            for i, max_score in enumerate(prev_max_scores):
                ...
                or (align_ident > max_align_ident and query_cov >= max_query_cov):
                    ...
                    raise Exception("m2p_miniprot: unknown max score relation between alignments.")
    ...
    if verbose: sys.stderr.write("m2p_miniprot: number of chimeras found: "+str(chimera_num)+"\n")
